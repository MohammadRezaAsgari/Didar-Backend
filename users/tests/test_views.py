...
from users.api.v1.views import (InstructorProfileAPIView, LoginPasswordAPIView,
...
class TestUserProfileAPIView(APITestCase):
    ...
    def test_user_get_profile_success(self):
        ...
        self.assertEqual(response_json.get("data")["gender"], self.user_obj.gender)
        self.assertEqual(response_json.get("data")["is_instructor"], False)
    ...
    def test_instructor_get_profile_success(self):
        ...
        self.assertEqual(response_json.get("success"), True)
        self.assertEqual(
            response_json.get("data")["first_name"], self.instructor_user_obj.first_name
        )
        self.assertEqual(
            response_json.get("data")["last_name"], self.instructor_user_obj.last_name
        )
        self.assertEqual(response_json.get("data")["phone"], "989171***222")
        self.assertEqual(
            response_json.get("data")["gender"], self.instructor_user_obj.gender
        )
        self.assertEqual(response_json.get("data")["is_instructor"], True)
