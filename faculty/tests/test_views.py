...
class TestFacultyByIdAPIView(APITestCase):
    def setUp(self):
        ...
        self.url = reverse(
            "faculty:v1:faculty_by_id", kwargs={"faculty_id": self.faculty.id}
        )
...
class TestFacultyDepartmentListAPIView(APITestCase):
    def setUp(self):
        ...
        self.url = reverse(
            "faculty:v1:department_list", kwargs={"faculty_id": self.faculty.id}
        )
    ...
    def test_get_faculty_departments_list_success(self):
        ...
        self.assertEqual(
            json_response.get("data").get("results")[0].get("faculty").get("id"),
            self.faculty.id,
        )
        self.assertIn("id", json_response.get("data").get("results")[0])
        self.assertIn("name", json_response.get("data").get("results")[0])
    ...
    def test_resolve_url(self):
        ...
        self.assertEqual(resolver.func.view_class, FacultyDepartmentListAPIView)
        self.assertEqual(resolver.namespace, "faculty:v1")
...
class TestDepartmentByIdAPIView(APITestCase):
    def setUp(self):
        ...
        self.url = reverse(
            "faculty:v1:department_by_id", kwargs={"department_id": self.department.id}
        )
    ...
    def test_get_faculty_department_by_id_success(self):
        ...
        self.assertEqual(json_response.get("success"), True)
        self.assertEqual(
            json_response.get("data").get("faculty").get("id"), self.faculty.id
        )
        self.assertIn("id", json_response.get("data"))
        self.assertIn("name", json_response.get("data"))

    def test_get_faculty_department_by_id_not_found_fail(self):
        url = reverse("faculty:v1:department_by_id", kwargs={"department_id": 99})
        response = self.client.get(url)
        json_response = response.json()
        self.assertEqual(response.status_code, 404)
        self.assertEqual(json_response.get("success"), False)
    ...
    def test_resolve_url(self):
        ...
        self.assertEqual(resolver.func.view_class, DepartmentByIdAPIView)
        self.assertEqual(resolver.namespace, "faculty:v1")
...
class TestDepartmentInstructorListAPIView(APITestCase):
    def setUp(self):
        ...
        self.url = reverse(
            ...
            kwargs={"department_id": self.department.id},
        )
    ...
    def test_get_department_instructors_list_not_found_fail(self):
        url = reverse("faculty:v1:department_instructors", kwargs={"department_id": 99})
        response = self.client.get(url)
        json_response = response.json()
        self.assertEqual(response.status_code, 404)
        self.assertEqual(json_response.get("success"), False)
    ...
    def test_resolve_url(self):
        ...
        self.assertEqual(resolver.view_name, "faculty:v1:department_instructors")
        self.assertEqual(resolver.func.view_class, DepartmentInstructorListAPIView)
        self.assertEqual(resolver.namespace, "faculty:v1")
